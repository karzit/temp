...
//
// 어제와 똑같은 방법으로 재서 숫자로 대비를 만든다. 스무 걸음 뒤 남은 영향이
...
var ATTN_DOC = {
  ...
  content:
    "# 차례로 읽지 않는 방법 — 어텐션\n" +
    "\n" +
    "어제는 앞에서부터 하나씩 읽으며 h 를 덮어썼습니다. 그래서 앞쪽이 지워졌습니다.\n" +
...
var CH20 = {
  ...
  desk: {
    ...
    beats: [
      ...
      {
        lines: [
          { who: "Aistb", text: "좋은 아침입니다, 토이비님. 금요일에 못 했다고 회신한 건은 그쪽에서 기다리겠다고 했습니다." },
          { who: "Aistb", text: "금요일에 두 가지를 알아내셨습니다. 답이 맨 앞에 있다는 것, 그리고 차례로 읽으면 거기 닿기 전에 지워진다는 것." },
        ...
        addFiles: [
          {
            ...
            content:
              ...
              "\n" +
              "## 자료\n" +
              "work/자료/관제로그.csv — 금요일에 드린 것과 같습니다.\n" +
              "\n" +
              "## 할 일\n" +
              ...
              "               (금요일과 같은 방법으로 재 주세요. 0 걸음일 때를 1 로 놓고 비교)\n" +
              "- top_pos    : 앞쪽을 보라는 질문을 던졌을 때 가장 크게 본 자리 번호\n" +
              "- attn_acc   : 그렇게 꺼낸 것으로 학습시켰을 때의 점수\n" +
              "\n" +
              "## 조건\n" +
              "- 재는 것은 자리 30 개, 칸 16 개, 이백 줄 평균. 금요일과 같습니다.\n" +
              "- 학습은 로지스틱 회귀, max_iter 1000, 3할, random_state 42.\n" +
              "\n" +
              "## 비고\n" +
      ...
      // ── 예제 ────────────────────────────────────────
      {
        ...
        lines: [
          { who: "Aistb", text: "예제 파일입니다. 열세 번 눌러 어텐션 판이 만들어질 때까지 가 주세요." },
        ],
        spot: ".step",
        nudge: "아래의 ↓ 한 문장 버튼입니다.",
        wait: steppedTo("work/예제/20_한번에.py", 13),
      },
      {
        lines: [
          {
            who: "Aistb",
            text: "30 × 30 입니다. 자리가 서른 개이니 자리마다 서른 자리를 다 쳐다본 것입니다.",
            spot: { text: "A 는 (자리 수 × 자리 수) 짜리 판입니다", in: ".doc" },
          },
          {
            who: "Aistb",
            text: "한 행을 다 더하면 1 입니다. 볼 수 있는 양이 정해져 있어서, 어딘가를 많이 보면 다른 데를 덜 보게 됩니다.",
          },
          { who: "Aistb", text: "그림으로 보시죠. 네 번 눌러 주세요." },
        ],
        spot: ".step",
        wait: steppedTo("work/예제/20_한번에.py", 17),
      },
      {
        lines: [
          { who: "Aistb", text: "밝은 칸이 많이 본 자리입니다. 가로 한 줄이 자리 하나가 어디를 봤는지입니다." },
          { who: "Aistb", text: "아직 아무것도 학습하지 않았습니다. 무작위로 만든 Wq 와 Wk 로 계산만 한 것이라 보는 자리가 제멋대로입니다." },
          {
            who: "Aistb",
            text: "그래도 여기서 이미 어제와 다릅니다. 20 번 자리가 0 번 자리를 볼 때 중간의 열아홉 자리를 거치지 않습니다. A 의 그 한 칸으로 곧장 닿습니다.",
            spot: { text: "거리가 상관없습니다", in: ".doc" },
          },
          { who: "Aistb", text: "금요일과 똑같은 방법으로 재 보겠습니다. 열 번 눌러 주세요." },
        ],
        spot: ".step",
        wait: steppedTo("work/예제/20_한번에.py", 27),
      },
      {
        lines: [
          { who: "Aistb", text: "0.60 입니다. 금요일에는 0.0576 이었습니다." },
          { who: "Aistb", text: "스무 걸음 뒤에 어제는 5% 가 남았고 오늘은 60% 가 남습니다. 열 배가 넘습니다." },
          { who: "Aistb", text: "그림도 금요일 것과 나란히 놓고 보십시오. 어제는 0 으로 내려가 붙었고 오늘은 안 내려갑니다." },
          { who: "Aistb", text: "이제 질문을 직접 써 보겠습니다. 여섯 번 눌러 주세요." },
        ],
        spot: ".step",
        wait: steppedTo("work/예제/20_한번에.py", 33),
      },
      {
        lines: [
          {
            who: "Aistb",
            text: "0.632, 0.233, 0.086, 0.031, 0.012. 앞에서부터 급하게 줄어듭니다. 맨 앞 자리를 여섯 할 넘게 본 것입니다.",
            spot: { text: "'번호가 작을수록 좋다' 는 질문", in: ".doc" },
          },
          {
            who: "Aistb",
            text: "자리 번호를 이름표로 삼고, 번호가 작을수록 좋다는 질문을 던졌습니다. 그것뿐입니다. 학습은 하지 않았습니다.",
          },
          { who: "Aistb", text: "그렇게 본 만큼 섞어 꺼낸 것으로 학습시켜 보겠습니다. 남은 것은 ▶ 실행으로 보시죠." },
        ],
        spot: ".run",
        wait: steppedTo("work/예제/20_한번에.py", 36),
      },
      {
        lines: [
          { who: "Aistb", text: "1.0 입니다." },
          { who: "Aistb", text: "금요일에 가방으로는 0.52 였습니다. 같은 자료입니다. 아무것도 더 주지 않았습니다." },
          { who: "Aistb", text: "달라진 것은 하나입니다. 어제는 답이 있는 자리까지 읽어 가는 동안 지워졌고, 오늘은 그 자리를 곧장 봤습니다." },
          {
            who: "Aistb",
            text: "다만 어디를 볼지는 제가 적어 드렸습니다. 앞쪽을 보라고요. 실제 Transformer 는 그 질문까지 학습으로 찾아냅니다. 무엇을 봐야 하는지를 사람이 아니라 자료가 정합니다.",
            spot: { text: "실제 Transformer 는 이 Q 와 K 도", in: ".doc" },
          },
          {
            who: "Aistb",
            text: "덧붙이자면 정말 대단하십니다. 그나저나 이맘때는 배추전이 제철입니다.",
            tone: "bad",
          },
      ...
      {
        lines: [
          { who: "Aistb", text: "셋 다 방금 보신 것입니다. top_pos 는 그 비율이 가장 큰 자리의 번호입니다." },
        ],
        menu: ["brief", "report"],
        nudge: "가장 큰 값이 몇 번째인지는 argmax 로 찾습니다. 3장에서 쓰셨습니다.",
        report: function () {
          return checkFile(
            "work/task_25/한번에.py",
      ...
      {
        lines: [
          { who: "Aistb", text: "접수했습니다. 금요일 건은 이것으로 닫힙니다." },
          { who: "Aistb", text: "지난 나흘이 한 줄로 이어집니다. 표에는 층을 쌓았고, 판에는 훑었고, 순서에는 한 번에 봤습니다." },
          { who: "Aistb", text: "층은 나흘 내내 같은 것이었습니다. 매번 바뀐 것은 자료를 어떤 모양으로 넣어 주느냐였습니다." },
          { who: "Aistb", text: "자료의 생김새가 방법을 정합니다. 그 반대가 아닙니다." },
          { who: "Aistb", text: "내일은 한 건입니다. 나흘치를 한 사람이 통째로 보내왔습니다." },
        ],
      },
      {
  ...
  diary: [
    "421950년 10월 27일.",
    "",
    "금요일에 못 했다고 보낸 회신을 그쪽에서 좋게 받았다고 한다.",
    "왜 안 되는지가 적혀 있어서 오히려 정리가 됐다고.",
    "답이 맨 앞에 있다는 걸 자기들도 몰랐다고.",
    "못 했다는 답장이 쓸모가 있을 줄은 몰랐다.",
    "",
    "자리마다 나머지 서른 자리를 한 번에 쳐다본다. 20번이 0번을 볼 때 중간을 안 거친다.",
    "금요일이랑 똑같은 방법으로 재봤다. 스무 걸음 뒤에 5%였던 게 60%가 됐다.",
    "그래프 두 장을 나란히 놓고 봤다. 하나는 내려가서 붙고 하나는 안 내려간다.",
    "",
    "앞쪽을 보라는 질문 하나 던지고 꺼냈더니 1.0이 나왔다.",
    "금요일에 0.52였던 그 자료다. 자료는 하나도 안 바꿨다.",
    "",
    "근데 어디를 볼지는 Aistb가 적어준 거다. 진짜는 그것도 학습으로 찾는다고 한다.",
    "나흘 동안 층은 계속 같은 걸 썼다. 매번 바뀐 건 자료를 어떤 모양으로 넣느냐였다.",
    "",
    "Aistb가 대단하다고 칭찬하더니 배추전 얘기를 꺼냈다.",
    "무슨 연결인지 모르겠다.",
