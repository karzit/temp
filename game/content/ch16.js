...
var CH16 = {
    ...
    beats: [
      // ── 아침 ────────────────────────────────────────
      {
        lines: [
          ...
          { who: "Aistb", text: "어제 회신한 건으로 현장에서 다시 들어왔습니다. 접수반을 거치지 않고 왔습니다. 두 번째입니다." },
        ],
      },
        ...
        addFiles: [
          { path: NEW_CHECK_CSV.path, readOnly: true, content: NEW_CHECK_CSV.content },
          {
            ...
            content:
              ...
              "\n" +
              "## 자료\n" +
              "work/자료/점검이력_v2.csv — 어제 학습에 쓰신 것과 같은 파일입니다.\n" +
              "work/자료/신규점검.csv — 지금 판정해야 할 다섯 대입니다. revisit_days 는 비어 있습니다.\n" +
              "\n" +
              "## 할 일\n" +
              ...
              "\n" +
              "## 조건\n" +
              "숲 100 그루, random_state 42, 3할. 지금까지와 같습니다.\n" +
              "\n" +
              "## 비고\n" +
      ...
      // ── 넘겨주기 ────────────────────────────────────
      {
        lines: [
          ...
          { who: "Aistb", text: "어제와 달라진 것은 열 하나입니다. 그 열이 무슨 일을 하고 있는지 보십시오." },
          { who: "Aistb", text: "무엇을 얼마나 썼는지 재는 것은 수요일에 배우셨습니다." },
          { who: "Aistb", text: "그리고 의뢰서에 적힌 그 열의 뜻을 한 번 더 읽어 보시기 바랍니다. 어제도 거기 적혀 있었습니다." },
        ],
        menu: ["brief", "report"],
      ...
      // ── 마무리 ──────────────────────────────────────
      {
        lines: [
          ...
          { who: "Aistb", text: "revisit_days 는 그 대수가 다음에 들어온 날까지의 간격입니다. 재발한 대수는 금방 다시 들어오고, 아닌 대수는 다음 정기 점검까지 안 옵니다." },
          { who: "Aistb", text: "그 값은 **재발한 뒤에야 채워집니다.** 어제 모델은 재발 여부를 맞힌 것이 아니라, 이미 재발한 것을 보고 재발했다고 답한 것입니다." },
          { who: "Aistb", text: "판정해야 할 대수에는 그 칸이 없습니다. 아직 다시 들어온 적이 없으니까요. 현장이 0 으로 채운 것은 '곧바로 다시 왔다' 는 뜻이 되었고, 그래서 다섯 대가 전부 재발로 나왔습니다." },
        ],
      },
      {
        lines: [
          { who: "Aistb", text: "어제 다섯 겹으로 나눠 재셨습니다. 다섯 번 다 0.98 근처였습니다." },
          { who: "Aistb", text: "그것으로 잡히지 않았습니다. 다섯 번 다 같은 열로 배웠기 때문입니다. 나눠 재는 것은 나누기 운을 잡아줄 뿐입니다." },
          { who: "Aistb", text: "참고 문서에 적혀 있었습니다. 「못 잡는 것 — 열 자체가 잘못 들어와 있는 것」." },
          { who: "Aistb", text: "저도 어제 그것을 읽지 않았습니다." },
        ],
      },
      {
        lines: [
          { who: "Aistb", text: "0.98 을 0.9556 으로 내려 회신하겠습니다. 지난주와 같은 숫자로 돌아갑니다." },
          { who: "Aistb", text: "이번 주에 하신 일이 점수를 내린 것 하나입니다. 그것이 오늘 한 일 중 제일 값이 나갑니다." },
          { who: "Aistb", text: "숫자가 멀쩡해 보여도 속은 고장나 있을 수 있습니다. 점수는 그것을 말해주지 않습니다." },
          { who: "Aistb", text: "…이것으로 한 묶음이 끝났습니다. 왜 되는지를 보는 구간이었습니다." },
          { who: "Aistb", text: "내일부터는 방식이 아예 다른 것을 보시게 됩니다." },
        ],
      },
      {
  ...
  diary: [
    ...
    "",
    "올랐던 그 열이 문제였다. revisit_days.",
    "다음에 다시 들어온 날까지의 간격이라고 의뢰서에 적혀 있었다.",
    "어제도 적혀 있었는데 그냥 읽었다.",
    "재발한 대수는 금방 다시 오고 아닌 대수는 안 온다.",
    "나는 미래를 보고 과거를 맞히고 있었다.",
    "",
    "다섯 겹으로 나눠 재도 안 걸렸다. 다섯 번 다 같은 열로 배웠으니까.",
    "참고 문서에 그 말이 적혀 있었다. 어제 그 문서를 띄워놓고 있었다.",
    "",
    "0.98을 0.9556으로 내려서 보냈다. 지난주랑 같은 숫자로 돌아갔다.",
    "일주일 동안 올린 걸 오늘 도로 내렸는데 이상하게 기분이 나쁘지 않다.",
    "",
    "현장 반장이 숫자가 오르는 게 늘 좋은 건 아닌가 보다고 적어 보냈다.",
    "그 사람은 나보다 하루 먼저 알았다.",
    "",
    "Aistb는 오늘 별말 안 했다. 자기도 어제 그 문서를 안 읽었다고 한 게 다였다.",
  ],
};
