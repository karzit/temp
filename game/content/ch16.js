    ...
    beats: [
      // ── 아침 ────────────────────────────────────────
      {
        lines: [
          ...
          { who: "Aistb", text: "어제 회신한 건으로 현장에서 다시 접수되었습니다. 두 번째입니다." },
        ],
      },
      ...
      // ── 의뢰 도착 ───────────────────────────────────
      {
        ...
        nudge: [
          ...
          "어제 올린 숫자가 도로 문제가 되었습니다. 오르는 것이 늘 좋은 것은 아닙니다. 저도 어제는 몰랐습니다.",
          "확인하지 않은 의뢰도 마감 기한은 동일하게 적용됩니다.",
          "worklog_GipsWToyb_0101: 폐기 요망",
        ],
        wait: function () {
      ...
      // ── 넘겨주기 ────────────────────────────────────
      {
        ...
        menu: ["brief", "report"],
        nudge: [
          "여섯 열로 학습한 숲에서 feature_importances_ 를 꺼내 열 이름과 짝지어 보세요.",
          "leak, acc, pred — 세 이름을 의뢰서 그대로 써 주세요.",
          "한 열이 나머지 다섯을 합친 것보다 크게 쓰이고 있다면, 그 열을 의심하십시오.",
          "그 열을 빼고 다시 만드십시오. 그리고 판정에 넣는 표도 다섯 열이어야 합니다.",
          "worklog_GipsWToyb_0102: 폐기 요망",
        ],
        report: function () {
          return checkFile(
            "work/task_21/누출.py",
      ...
      },
      {
        ...
        nudge: [
          ...
          "일주일간 올리신 것을 오늘 도로 내리셨습니다. 내리는 것이 옳을 때도 있습니다.",
          "현장 반장은 하루 먼저 알았습니다. 저는 어제 그 문서를 읽지 않았습니다. …오늘은 별로 드릴 말씀이 없습니다.",
          "worklog_GipsWToyb_0103: 폐기 요망",
        ],
        wait: function () {
          return false;
        },
