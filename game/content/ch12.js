...
var CH12 = {
  ...
  desk: {
    ...
    beats: [
      ...
      {
        lines: [
          { who: "Aistb", text: "좋은 아침입니다, 토이비님. 어제 회신을 보고 한울운수에서 정비운영팀 쪽으로 넘겼습니다." },
          { who: "Aistb", text: "어제 마지막에 남은 것이 하나 있었습니다. 질문 횟수를 세 번으로 묶는 것이 맞는지 아무도 모른다는 것입니다." },
          { who: "Aistb", text: "그 문제를 푸는 방법이 두 가지입니다. 몇 번이 맞는지 알아내거나, 한 그루에 매달리지 않거나." },
        ...
        addFiles: [
          {
            ...
            content:
              "# 의뢰 0017 — 재발 예측 모델 납품\n" +
              "\n" +
              "발신: 한울운수 통합관제센터 정비운영팀 / 규 M. 바이스\n" +
              "수신: 바로벤토 — 깁스 W 토이비\n" +
              "\n" +
              "## 자료\n" +
              "work/자료/점검이력.csv — 관제운영팀에서 넘겨받은 것과 같은 파일입니다.\n" +
              "\n" +
              "## 할 일\n" +
              ...
              "- pred        : 아래 세 대를 판정한 결과 (재발 아님 0 / 재발 1)\n" +
              "\n" +
              ...
              "\n" +
              "## 조건\n" +
              "- 열은 어제와 같은 다섯입니다. 3할을 떼어 두시고 random_state 는 42 입니다.\n" +
              "- 그루는 100 그루로 해주세요.\n" +
              "\n" +
              "## 비고\n" +
      ...
      // ── 예제 ────────────────────────────────────────
      {
        ...
        lines: [
          { who: "Aistb", text: "예제 파일입니다. 어제 만든 한 그루를 먼저 다시 세워 놓고, 그 옆에 숲을 심습니다." },
          { who: "Aistb", text: "열한 번 눌러 어제 점수가 다시 나올 때까지 가 주세요. 숲을 세우는 데는 몇 초 걸립니다." },
        ],
        spot: ".step",
        nudge: "아래의 ↓ 한 문장 버튼입니다.",
        wait: steppedTo("work/예제/13_숲.py", 11),
      },
      {
        lines: [
          { who: "Aistb", text: "0.93 입니다. 어제 것과 같습니다. random_state 를 고정해 두었으니 같은 자료에서는 같은 트리가 나옵니다." },
          { who: "Aistb", text: "이제 100 그루입니다. 네 번 눌러 주세요." },
        ],
        spot: ".step",
        wait: steppedTo("work/예제/13_숲.py", 15),
      },
      {
        lines: [
          {
          ...
          {
            who: "Aistb",
            text: "어제 한 그루에서도 연습용이 1.0 이었습니다. 그때는 시험용이 0.9 로 떨어졌습니다. 이번에는 안 떨어졌습니다.",
          },
          {
            who: "Aistb",
            text: "그루마다 조금씩 다르게 외웠기 때문입니다. 한 그루가 잘못 외운 것을 나머지 아흔아홉이 눌러 버립니다. 다수결이라 그렇습니다.",
            spot: { text: "서로 조금씩 다른 그루를 여럿 심어", in: ".doc" },
          },
          { who: "Aistb", text: "마지막 한 줄은 ▶ 실행으로 보시죠." },
        ],
        spot: ".run",
        wait: steppedTo("work/예제/13_숲.py", 16),
      },
      {
        lines: [
          {
            who: "Aistb",
            text: "열마다 하나씩, 전부 더하면 1 입니다. delay 와 reboots 가 큽니다. 어제 규칙에서 맨 위와 그 아래에 있던 두 열입니다.",
            spot: { text: "model.feature_importances_", in: ".doc" },
          },
          {
            who: "Aistb",
            text: "계수와 다릅니다. 부호가 없습니다. 많이 썼다는 것만 말할 뿐, 어느 쪽으로 미는지는 안 알려줍니다.",
            spot: { text: "부호가 없고 방향도 없습니다", in: ".doc" },
          },
          {
            who: "Aistb",
            text: "그리고 오늘 하나 잃으셨습니다. export_text 를 쓸 수 없습니다. 100 그루를 글로 읽을 수는 없습니다.",
            spot: { text: "규칙은 못 읽습니다", in: ".doc" },
          },
          {
            who: "Aistb",
            text: "어제 그 공장은 근거를 대라고 했습니다. 그때 이 모델을 줬다면 대지 못했을 것입니다. 잘 맞히는 것과 설명이 되는 것은 다릅니다.",
          },
          {
            who: "Aistb",
      ...
      {
        lines: [
          { who: "Aistb", text: "점수와 중요도는 방금 찍어 보신 것입니다. 판정 세 건이 남았습니다." },
          { who: "Aistb", text: "세 대를 한 표에 담아 한 번에 넣으시면 됩니다. 열 이름과 순서를 학습할 때와 맞추셔야 합니다." },
        ],
        menu: ["brief", "report"],
      ...
      {
        lines: [
          { who: "Aistb", text: "접수했습니다. 이대로 납품하겠습니다." },
          { who: "Aistb", text: "가 번은 재발로 나왔습니다. 오류도 적고 재부팅도 없는 대수입니다. 정비 반장이 곧 온다고 한 그 대수입니다." },
          { who: "Aistb", text: "이유는 응답 지연입니다. 520ms 이고, 그 대수는 개선안을 적용했습니다. 규칙 맨 아래 갈래가 그 둘을 함께 물어봤습니다." },
          { who: "Aistb", text: "반장은 그것을 몸으로 알고 있었고 말로 못 했습니다. 모델은 말로 했습니다. 오늘은 그렇게 되었습니다." },
        ],
      },
      {
  ...
  diary: [
    ...
    "근데 올린 대가로 규칙을 못 읽게 됐다. 백 그루를 글로 찍을 수는 없으니까.",
    "이틀 전에 통조림 공장이 근거를 대라고 했었다. 그때 이걸 줬으면 못 댔을 거다.",
    "",
    "가 번이 재발로 나왔다. 오류도 적고 재부팅도 없는 대수인데.",
    "정비 반장이 저건 곧 온다고 했다는 그 대수다. 이유는 못 댔다고 적혀 있었다.",
    "응답이 느리고 개선안을 받은 대수였다.",
    "반장은 그걸 어떻게 알았을까.",
    "",
    "Aistb는 오늘 좀 더 심했다.",
    "내가 뭘 물었는지 칭찬하더니 갑자기 갈비찜 얘기로 샜다.",
    "나한테 한 말이긴 한 것 같은데",
    "무슨 말인지는 모르겠다.",
    "그게 더 이상했다.",
  ],
