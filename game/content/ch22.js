...
var LM_TOOL = {
  ...
  [
    ...
    "",
    "돌려주는 것은 글자 하나입니다. 같은 것을 물으면 늘 같은 답이 나옵니다.",
    "",
    "## 알아 두실 것",
    "",
...
var CH22 = {
  ...
  desk: {
    ...
    beats: [
      ...
      {
        lines: [
          { who: "Aistb", text: "좋은 아침입니다, 토이비님. 어제 말씀드린 대로 오늘부터는 만들지 않습니다." },
          { who: "Aistb", text: "회사가 쓰는 언어모델이 하나 있습니다. work/도구 에 넣어 두었습니다." },
          { who: "Aistb", text: "미리 말씀드리면, 바깥에서 도는 큰 것은 이 장비에 안 들어갑니다. 이건 같은 방식으로 부를 수 있게 만들어 둔 작은 것입니다." },
          { who: "Aistb", text: "부리는 법은 크기와 상관없이 같습니다. 오늘 배우실 것은 그쪽입니다." },
        ],
      },
        ...
        addFiles: [
          ...
          { path: MANUAL_CSV.path, readOnly: true, content: MANUAL_CSV.content },
          {
            ...
            content:
              ...
              "\n" +
              "## 자료\n" +
              "work/자료/정비지침.csv — 저희 정비지침을 문단으로 쪼갠 것입니다. 36 개입니다.\n" +
              "\n" +
              "  no   : 문단 번호\n" +
              "  text : 문단 하나\n" +
              "\n" +
      ...
      // ── 예제 ────────────────────────────────────────
      {
        ...
        lines: [
          { who: "Aistb", text: "예제 파일입니다. 다섯 번 눌러 첫 답을 보시죠." },
        ],
        spot: ".step",
        nudge: "아래의 ↓ 한 문장 버튼입니다.",
        wait: steppedTo("work/예제/21_도구.py", 5),
      },
      {
        lines: [
          {
            who: "Aistb",
            text: "답이 왔습니다. 121도. 맞는 말입니다. 이 모델이 배운 적 있는 것입니다.",
            spot: { text: "from 사내모델 import ask", in: ".doc" },
          },
          { who: "Aistb", text: "fit 을 부르지 않으셨습니다. 학습은 이미 끝나 있고 저희는 부르기만 합니다." },
          { who: "Aistb", text: "이번에는 고객사 지침에 있는 것을 물어보겠습니다. 한 번 눌러 주세요." },
        ],
        spot: ".step",
        wait: steppedTo("work/예제/21_도구.py", 6),
      },
      {
        lines: [
          { who: "Aistb", text: "'보통은 담당 부서의 내규에 정해져 있습니다.'" },
          { who: "Aistb", text: "이 모델은 한울운수의 지침을 배운 적이 없습니다. 그런데 모른다고 하지 않았습니다." },
          {
            who: "Aistb",
            text: "말이 되는 문장을 하나 만들어 내놓았습니다. 문장만 봐서는 아는 것을 답한 것인지 지어낸 것인지 구별되지 않습니다.",
            spot: { text: "모르는 것을 물으면", in: ".doc" },
          },
          { who: "Aistb", text: "실제 지침에는 뭐라고 적혀 있는지 보시겠습니다. 두 번 눌러 주세요." },
        ],
        spot: ".step",
        wait: steppedTo("work/예제/21_도구.py", 8),
      },
      {
        lines: [
          { who: "Aistb", text: "4000시간 또는 6개월. 아까 답에는 없던 것입니다." },
          { who: "Aistb", text: "이 문단을 같이 주고 다시 물어보겠습니다. 한 번 눌러 주세요." },
        ],
        spot: ".step",
        wait: steppedTo("work/예제/21_도구.py", 9),
      },
      {
        lines: [
          {
            who: "Aistb",
            text: "이번에는 맞게 답했습니다. 모델이 어제까지 몰랐던 것을 방금 알게 된 것이 아닙니다. 저희가 답이 든 글을 손에 쥐여 준 것입니다.",
            spot: { text: "무엇을 넣어 주느냐가 답을 정한다", in: ".doc" },
          },
          { who: "Aistb", text: "학습시킬 수 없고 안을 고칠 수도 없습니다. 바꿀 수 있는 것은 넣어 주는 것 하나뿐입니다." },
          { who: "Aistb", text: "지시도 넣어 주는 것에 들어갑니다. 남은 셋은 ▶ 실행으로 보시죠." },
        ],
        spot: ".run",
        wait: steppedTo("work/예제/21_도구.py", 12),
      },
      {
        lines: [
          {
            who: "Aistb",
            text: "'짧게' 를 붙였더니 앞부분만 왔고, '숫자만' 을 붙였더니 4000시간 6개월 만 왔습니다. 묻는 말은 그대로였습니다.",
            spot: { text: "짧게 / 한 줄로", in: ".doc" },
          },
          { who: "Aistb", text: "마지막은 상관없는 문단을 준 것입니다. '주신 글에서는 찾지 못했습니다.' 라고 했습니다." },
          {
            who: "Aistb",
            text: "이것이 오늘 제일 중요합니다. 아무 글도 안 주면 지어내고, 엉뚱한 글을 주면 못 찾았다고 합니다. 맞는 글을 주면 맞게 답합니다.",
          },
          {
            who: "Aistb",
            text: "그러니 이 도구가 쓸모 있느냐는 이 도구에 달려 있지 않습니다. 맞는 글을 찾아 쥐여 줄 수 있느냐에 달려 있습니다.",
          },
          {
            who: "Aistb",
      ...
      {
        lines: [
          { who: "Aistb", text: "셋 다 방금 보신 것입니다. 돌아온 글자를 그대로 담으시면 됩니다." },
        ],
        menu: ["brief", "report"],
      ...
      // ── 마무리 ──────────────────────────────────────
      {
        lines: [
          ...
          { who: "Aistb", text: "그쪽이 하려는 것은 됩니다. 다만 모델을 고쳐서 되는 것이 아니라, 물어볼 때마다 맞는 문단을 찾아 같이 넣어 주면 됩니다." },
          { who: "Aistb", text: "그러면 남는 문제가 하나입니다. 서른여섯 문단 중에 어느 것이 맞는 문단인지를 무엇이 정합니까." },
          { who: "Aistb", text: "오늘은 제가 0 번이라고 알려드렸습니다. 내일은 그것을 찾는 법을 하겠습니다." },
        ],
      },
      {
  ...
  diary: [
    "421950년 10월 29일.",
    "",
    "fit 을 한 번도 안 쳤다. 한 달 만에 처음이다.",
    "",
    "냉각팬 교체 주기를 물었더니 “보통은 담당 부서의 내규에 정해져 있습니다” 라고 답했다.",
    "틀린 말은 아닌데 아무 말도 아니다.",
    "",
    ...
    "",
    "36개 중에 어느 게 맞는 문단인지는 오늘 Aistb가 알려줬다. 0번이라고.",
    "내일은 그걸 찾는 걸 한다고 한다.",
    "",
    "Aistb가 내 질문을 칭찬하더니 된장찌개 얘기로 샜다.",
    "냉각팬이랑 무슨 상관인지.",
