    ...
    beats: [
      // ── 아침 ────────────────────────────────────────
      {
        lines: [
          ...
          { who: "Aistb", text: "오늘은 세는 것이 아니라 버리는 날입니다. 자료는 어제 것 그대로입니다." },
        ],
        ...
        addFiles: [
          {
            ...
            content:
              "# 의뢰 0012 — 검사 기록 정리\n" +
              "\n" +
              "발신: 런천미트연구소 3라인 관리 / 유리 D. 하만\n" +
              "수신: 바로벤토 — 깁스 W 토이비\n" +
              "\n" +
              "## 자료\n" +
              "work/자료/검사기록.csv — 어제 보내드린 것과 같은 파일입니다.\n" +
              "\n" +
              "## 할 일\n" +
              "쓸 수 없는 행을 걷어내고, 나중에 학습에 넣을 수 있는 모양으로 만들어 주세요.\n" +
              "work/task_12/손질.py 를 만들고, 손질을 마친 표를 clean 에 넣어 주시면 됩니다.\n" +
              "\n" +
              "걷어낼 것은 이렇습니다.\n" +
              "\n" +
              "- 앞에 똑같은 행이 이미 있었던 행\n" +
      ...
      // ── 예제 ────────────────────────────────────────
      {
        ...
        lines: [
          { who: "Aistb", text: "예제 파일입니다. 한 문장씩 보시겠습니다. 숫자가 어떻게 줄어드는지가 오늘의 볼거리입니다." },
          { who: "Aistb", text: "다섯 번 눌러 두 번째 숫자가 나올 때까지 가 주세요." },
        ],
        spot: ".step",
        nudge: "아래의 ↓ 한 문장 버튼입니다.",
        wait: steppedTo("work/예제/09_손질.py", 5),
      },
      {
        lines: [
          {
            who: "Aistb",
            text: "겹치는 행이 빠졌습니다. 어제 세신 그 숫자만큼 줄어 있을 것입니다.",
            spot: { text: "df.drop_duplicates()", in: ".doc" },
          },
          {
            who: "Aistb",
            text: "여기가 오늘 제일 중요한 부분입니다. drop_duplicates 는 df 를 건드리지 않았습니다.",
          },
          {
            who: "Aistb",
            text: "버린 결과를 새 표로 내놓았을 뿐이고, 그것을 clean 에 받아 두었기 때문에 남은 것입니다.",
          },
          { who: "Aistb", text: "받지 않으면 그냥 사라집니다. 네 번 더 눌러 주세요." },
        ],
        spot: ".step",
        wait: steppedTo("work/예제/09_손질.py", 9),
      },
      {
        lines: [
          {
            who: "Aistb",
            text: "dropna 는 빈칸이 하나라도 있는 행을 버립니다. 열이 아니라 행 단위입니다.",
            spot: { text: "df.dropna()", in: ".doc" },
          },
          {
            who: "Aistb",
            text: "그다음은 범위입니다. 어제 999를 찾으신 그 조건을 이번에는 세는 데가 아니라 남기는 데 썼습니다.",
            spot: { text: "& 는 '그리고' 입니다", in: ".doc" },
          },
          { who: "Aistb", text: "남은 두 줄은 ▶ 실행으로 보시죠." },
        ],
        spot: ".run",
        wait: steppedTo("work/예제/09_손질.py", 11),
      },
      {
        lines: [
          {
            who: "Aistb",
            text: "map 은 값을 표대로 바꿔치기합니다. 합격은 0, 불합격은 1 이 되었습니다.",
            spot: { text: 'df["result"].map', in: ".doc" },
          },
          { who: "Aistb", text: "글자를 굳이 숫자로 바꾸는 이유는 내일 아시게 됩니다. 오늘은 그렇게 해 두시면 됩니다." },
        ],
      },
      ...
      // ── 실습 ────────────────────────────────────────
      {
        ...
        lines: [
          { who: "Aistb", text: "실습 과제입니다. 1번부터 3번까지는 앞의 결과 위에 이어서 손질하시는 것입니다." },
        ],
        spot: ".run",
      ...
      {
        lines: [
          { who: "Aistb", text: "의뢰로 돌아가시죠. 버릴 것이 네 가지, 더할 열이 하나입니다." },
      ...
      // ── 마무리 ──────────────────────────────────────
      {
        lines: [
          ...
          { who: "Aistb", text: "62행으로 받아 55행을 돌려드립니다. 일곱 행은 쓸 수 없는 것이었습니다." },
          { who: "Aistb", text: "내일은 이 표로 무엇을 할 수 있는지 보시게 됩니다." },
        ],
      },
      {
