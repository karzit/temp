...
var CH07 = {
  ...
  desk: {
    ...
    beats: [
      ...
      {
        lines: [
          { who: "Aistb", text: "좋은 아침입니다, 토이비님. 어제 회신하신 숫자를 확인한 뒤, 같은 곳에서 다시 연락이 왔습니다." },
          { who: "Aistb", text: "금일은 걷어내는 날입니다. 자료는 어제와 동일한 파일입니다." },
        ],
      ...
      // ── 의뢰 도착 ───────────────────────────────────
      {
        lines: [{ who: "Aistb", text: "의뢰가 접수되었습니다." }],
        addFiles: [
          {
        ...
        nudge: [
          ...
          "어제 세신 것을 오늘 걷어냅니다. 순서가 있는 데는 이유가 있습니다.",
          "확인하지 않은 의뢰도 마감 기한은 동일하게 적용됩니다.",
          "worklog_GipsWToyb_0065: 폐기 요망",
        ],
        wait: function () {
      ...
      // ── 예제 ────────────────────────────────────────
      {
        ...
        lines: [
          { who: "Aistb", text: "먼저 예제로 손질 순서를 살펴보겠습니다. 중복, 빈칸, 범위 밖을 차례로 덜어냅니다." },
          { who: "Aistb", text: "다섯 번 눌러 주세요." },
        ],
        spot: ".step",
        nudge: [
          { text: "아래의 ↓ 한 문장 버튼입니다.", spot: ".step" },
          { text: "↓ 한 문장 버튼을 다섯 번 누르시면 손질 순서가 나옵니다.", spot: ".step" },
          "손질은 원본을 바꾸지 않습니다. 결과를 변수에 받아 두지 않으면 사라집니다. 노력도 마찬가지입니다.",
          "무엇을 버릴지 정하는 것이 무엇을 남길지 정하는 것보다 어렵습니다. 인력도 그렇다고 합니다.",
          "worklog_GipsWToyb_0066: 폐기 요망",
        ],
      ...
      // ── 실습 ────────────────────────────────────────
      {
        ...
        lines: [
          { who: "Aistb", text: "실습 과제입니다. 1번부터 3번까지는 앞의 결과 위에 이어서 손질하시면 됩니다. 완료하신 후 완료 보고를 눌러 주세요." },
        ],
        menu: ["report"],
        nudge: [
          "중간 결과를 변수에 받아 두고 그 위에 다음 손질을 얹으세요.",
          "a, b, c, g — 네 이름을 그대로 써 주세요.",
          "받지 않으면 남지 않습니다. 손질도, 공적도 마찬가지입니다.",
          "네 자리를 모두 채우셔야 채점이 진행됩니다.",
          "worklog_GipsWToyb_0067: 폐기 요망",
        ],
        report: function () {
          return checkFile(
            "work/실습/08_걷어내기.py",
      ...
      // ── 의뢰 처리 ───────────────────────────────────
      {
        lines: [
          ...
          { who: "Aistb", text: "예제에서는 온도만 다루었습니다. 중량도 같은 방식으로 한 번 더 걸러 주셔야 합니다." },
        ],
        menu: ["brief", "report"],
        nudge: [
      ...
      },
      {
        ...
        nudge: [
          ...
          "합격을 0, 불합격을 1 로 바꾸신 이유는 내일 아시게 됩니다. 오늘 알려 드리지 않는 데도 이유가 있습니다.",
          "62행이 55행이 되었습니다. 일곱 행은 어디로 갔느냐 물으시면, 버리셨습니다.",
          "worklog_GipsWToyb_0069: 폐기 요망",
        ],
        wait: function () {
          return false;
        },
