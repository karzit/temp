...
var CH03 = {
  ...
  desk: {
    ...
    beats: [
      ...
      {
        lines: [
          { who: "Aistb", text: "모양을 바꾸고, 행별로 더하고, 자리를 찾고, 조건으로 셉니다. 어제 하신 것 그대로입니다." },
        ],
        menu: ["brief", "report"],
      ...
      },
      {
        lines: [
          {
            who: "Aistb",
            text: "참/거짓 목록은 다른 배열의 대괄호에도 넣을 수 있습니다. 길이만 같으면 됩니다.",
      ...
      // ── 마무리 ──────────────────────────────────────
      {
        lines: [
          ...
          { who: "Aistb", text: "배운 것 하나로 풀리는 일은 많지 않습니다. 오늘 마지막 건이 그런 경우였습니다." },
  ...
  diary: [
    "421950년 10월 4일.",
    "",
    "마지막 게 어려웠다. 근데 새로 나온 건 하나도 없었다. 그게 더 짜증난다.",
