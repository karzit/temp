...
var CH08 = {
  ...
  desk: {
    ...
    beats: [
      ...
      {
        lines: [
          { who: "Aistb", text: "좋은 아침입니다, 토이비님. 어제 회신하신 정리본은 정상 접수되었다고 합니다." },
          { who: "Aistb", text: "어제 마지막에 합격을 0, 불합격을 1 로 바꾸셨습니다. 금일 그 이유를 확인하시게 됩니다." },
          { who: "Aistb", text: "금일은 아직 나오지 않은 판정을 맞히는 것을 만들어 보겠습니다." },
        ],
      },

      // ── 의뢰 도착 ───────────────────────────────────
      {
        lines: [{ who: "Aistb", text: "마침 시험해 볼 만한 건이 하나 접수되어 있습니다." }],
        addFiles: [
          { path: SAMPLE_CSV.path, readOnly: true, src: SAMPLE_CSV.src },
          {
        ...
        nudge: [
          ...
          "손질한 자료로 맞히는 것을 만드는 첫날입니다. 그간의 손질이 이를 위한 것이었습니다.",
          "확인하지 않은 의뢰도 마감 기한은 동일하게 적용됩니다.",
          "worklog_GipsWToyb_0070: 폐기 요망",
        ],
        wait: function () {
      ...
      // ── 예제 ────────────────────────────────────────
      {
        ...
        lines: [
          { who: "Aistb", text: "두 번째 줄은 도구를 내려받느라 이십 초쯤 소요됩니다." },
          { who: "Aistb", text: "일곱 번 눌러 주세요." },
        ],
        spot: ".step",
        nudge: [
          { text: "아래의 ↓ 한 문장 버튼입니다. 도구를 받는 동안은 잠시 기다리셔야 합니다.", spot: ".step" },
          { text: "↓ 한 문장 버튼을 일곱 번 누르시면 네 토막이 차례로 실행됩니다.", spot: ".step" },
          "도구를 받는 동안 화면이 멈춘 것처럼 보일 수 있습니다. 저와 달리 인내심이 필요합니다.",
          "모델은 마법이 아닙니다. 네 토막으로 나뉜 절차일 뿐입니다. 저 역시 그렇습니다.",
          "worklog_GipsWToyb_0071: 폐기 요망",
        ],
        wait: steppedTo("work/예제/11_첫모델.py", 7),
      },
      {
        lines: [
          {
            who: "Aistb",
            text: "X 는 온도와 시간, y 는 어제 만드신 fail 입니다.",
            spot: { text: 'X = df[["temp", "minutes"]]', in: ".doc" },
          },
          { who: "Aistb", text: "두 번 더 눌러 주세요." },
        ],
        spot: ".step",
        wait: steppedTo("work/예제/11_첫모델.py", 9),
      },
      {
        lines: [
          {
            who: "Aistb",
            text: "스물네 행을 열여섯과 여덟으로 갈랐습니다. 여덟은 감춰 둡니다.",
            spot: { text: "test_size=0.3", in: ".doc" },
          },
          {
            who: "Aistb",
            text: "답을 보여준 문제로 시험을 보면 점수가 실력이 아닙니다.",
          },
          { who: "Aistb", text: "두 번 더 눌러 주세요." },
        ],
        spot: ".step",
        wait: steppedTo("work/예제/11_첫모델.py", 11),
      },
      {
        lines: [
          {
            who: "Aistb",
            text: "fit 이 학습입니다. 화면에는 아무것도 안 나왔지만 model 안이 바뀌었습니다.",
            spot: { text: "model.fit(X_train, y_train)", in: ".doc" },
          },
          { who: "Aistb", text: "무슨 일이 일어났는지는 지금 설명하지 않겠습니다. 되는 것부터 보시죠." },
          { who: "Aistb", text: "두 번 더 눌러 주세요." },
        ],
        spot: ".step",
        wait: steppedTo("work/예제/11_첫모델.py", 13),
      },
      {
        lines: [
          {
            who: "Aistb",
            text: "위가 모델의 답, 아래가 실제 답입니다.",
            spot: { text: "model.predict(X_test)", in: ".doc" },
          },
          { who: "Aistb", text: "마지막 한 줄은 ▶ 실행으로 보시죠." },
        ],
        spot: ".run",
        wait: steppedTo("work/예제/11_첫모델.py", 14),
      },
      {
        lines: [
          {
            who: "Aistb",
            text: "1.0 이면 여덟 건을 다 맞힌 것입니다.",
            spot: { text: "model.score(X_test, y_test)", in: ".doc" },
          },
          { who: "Aistb", text: "여덟 건은 적은 수라 그대로 믿으실 것은 아닙니다." },
          { who: "Aistb", text: "네 토막입니다. 답 열을 숫자로. X 와 y 로. 시험용을 떼어. 학습시키고 점수." },
          { who: "Aistb", text: "참고 문서 맨 앞에 순서를 적어 두었습니다. 내일은 그 문서만 보고 하시게 됩니다." },
        ],
      },
      ...
      {
        lines: [
          { who: "Aistb", text: "점수 하나와 판정 두 건입니다." },
          { who: "Aistb", text: "새로 들어온 것을 판정하실 때는 표 모양으로 넣으셔야 합니다. 열 이름과 순서가 학습할 때와 같아야 합니다." },
        ],
        menu: ["brief", "report"],
        nudge: [
          'pd.DataFrame({"temp": [...], "minutes": [...]}) 를 만들어 model.predict 에 넣으시면 두 건이 한 번에 나옵니다.',
          "acc, pred — 두 이름을 의뢰서 그대로 써 주세요.",
          "시험용은 3할, random_state 는 42 입니다. 사내 기준이니 바꾸지 마세요.",
          "학습에는 X_train 만 넣으십시오. 시험용을 보여주고 시험을 보면 점수가 실력이 아닙니다.",
          "worklog_GipsWToyb_0072: 폐기 요망",
        ],
        report: function () {
          return checkFile(
            "work/task_13/시험.py",
      ...
      },
      {
        ...
        nudge: [
          ...
          "여덟 건을 다 맞히셨습니다. 다만 여덟 건은 적은 수라, 그대로 믿으실 것은 아닙니다.",
          "fit 은 아무 말 없이 학습합니다. 결과를 알려 주지 않는다는 점에서, 저보다 과묵합니다.",
          "worklog_GipsWToyb_0073: 폐기 요망",
        ],
        wait: function () {
          return false;
        },
