...
var CH04 = {
  ...
  desk: {
    ...
    beats: [
      ...
      {
        lines: [
          { who: "Aistb", text: "좋은 아침입니다, 토이비님. 금요일에 하신 여섯 건은 각 팀에서 잘 받았다고 합니다." },
          { who: "Aistb", text: "오후에 인사팀 의뢰가 세 건 옵니다. 자료에 사람 이름이 섞여 있습니다." },
          { who: "Aistb", text: "NumPy 는 한 종류만 담습니다. 이름과 숫자가 한 표에 섞이면 Pandas 입니다." },
        ],
      },
      ...
      {
        lines: [
          { who: "Aistb", text: "오후에는 인사팀 세 건입니다." },
