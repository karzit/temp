...
var FIND_DOC = {
  ...
  content:
    "# 문서를 찾는 법\n" +
    "\n" +
    "13장에서 문장을 숫자로 바꾸는 것을 하셨습니다. 그것을 그대로 씁니다.\n" +
...
var CH23 = {
  ...
  desk: {
    ...
    beats: [
      ...
      {
        lines: [
          { who: "Aistb", text: "좋은 아침입니다, 토이비님. 어제 회신을 보고 그쪽에서 다음 단계를 보내왔습니다." },
          { who: "Aistb", text: "어제 마지막에 남은 것이 하나 있었습니다. 서른여섯 문단 중에 어느 것이 맞는 문단인지를 무엇이 정하느냐." },
          { who: "Aistb", text: "어제는 제가 0 번이라고 알려드렸습니다. 오늘은 그 자리를 직접 찾으시게 됩니다." },
        ...
        addFiles: [
          {
            ...
            content:
              ...
              "\n" +
              "발신: 한울운수 통합관제센터 문서관리 / 미 R. 홀란트\n" +
              "수신: 바로벤토 — 깁스 W 토이비\n" +
              "\n" +
              "## 자료\n" +
              "work/자료/정비지침.csv — 어제 드린 것과 같습니다. 36 문단입니다.\n" +
              "\n" +
              "## 할 일\n" +
              ...
              "\n" +
              "## 조건\n" +
              "- 낱말을 세는 것은 기본 설정 그대로 쓰시면 됩니다.\n" +
              "- 줄일 때 칸은 16 개, random_state 는 42 입니다.\n" +
              "\n" +
              "## 비고\n" +
      ...
      // ── 예제 ────────────────────────────────────────
      {
        ...
        lines: [
          { who: "Aistb", text: "예제 파일입니다. 열한 번 눌러 문서를 숫자로 바꾼 표를 보시죠." },
        ],
        spot: ".step",
        nudge: "아래의 ↓ 한 문장 버튼입니다.",
        wait: steppedTo("work/예제/22_찾기.py", 11),
      },
      {
        lines: [
          {
            who: "Aistb",
            text: "36 × 250 입니다. 문서가 서른여섯, 낱말이 이백오십입니다. 13장에서 보신 그 모양입니다.",
            spot: { text: "M = vec.fit_transform(문서들)", in: ".doc" },
          },
          { who: "Aistb", text: "그리고 채워진 칸이 0.033 입니다. 아흔일곱 칸 중 아흔넷이 0 입니다. 문단 하나에 낱말이 몇 개 안 들어가니 당연합니다." },
          { who: "Aistb", text: "여기까지는 어제와 같고, 다른 점은 학습이 없다는 것입니다. 여섯 번 눌러 질문을 넣어 보시죠." },
        ],
        spot: ".step",
        wait: steppedTo("work/예제/22_찾기.py", 17),
      },
      {
        lines: [
          {
            who: "Aistb",
            text: "질문에서 살아남은 낱말이 하나뿐입니다. '냉각팬' 입니다. 나머지는 문서에 없는 낱말이라 버려졌습니다.",
            spot: { text: "질문에만 있고 문서에는 없는 낱말은", in: ".doc" },
          },
          { who: "Aistb", text: "그 하나로 0 번 문단을 0.326 에 찾았습니다. 어제 제가 알려드린 그 문단입니다." },
          { who: "Aistb", text: "이제 줄여 보겠습니다. 다섯 번 눌러 주세요." },
        ],
        spot: ".step",
        wait: steppedTo("work/예제/22_찾기.py", 22),
      },
      {
        lines: [
          {
            who: "Aistb",
            text: "36 × 16 입니다. 이백오십 칸이 열여섯 칸이 되었습니다. 문단 하나가 숫자 열여섯 개로 줄었습니다.",
            spot: { text: "E = svd.fit_transform(M)", in: ".doc" },
          },
          { who: "Aistb", text: "0 번 문단의 열여섯 개가 화면에 있습니다. 이 숫자 묶음을 그 문서의 임베딩이라고 부릅니다. 문서가 놓인 자리입니다." },
          { who: "Aistb", text: "그 자리로 다시 찾아도 0 번입니다. 이백오십 칸이 다 필요했던 것이 아니었습니다." },
          { who: "Aistb", text: "나머지 넷도 해보겠습니다. 두 번 눌러 주세요." },
        ],
        spot: ".step",
        wait: steppedTo("work/예제/22_찾기.py", 24),
      },
      {
        lines: [
          { who: "Aistb", text: "넷은 맞았습니다. 마지막 줄을 보십시오." },
          { who: "Aistb", text: "부팅 질문이 0 번 냉각팬 문단을 가져왔습니다. 점수는 0.0 입니다." },
          {
            who: "Aistb",
            text: "겹치는 낱말이 하나도 없었다는 뜻입니다. '부팅이' 는 문서의 '부팅에' 와 다른 낱말이고, '계속' 도 '되면' 도 지침에 없습니다.",
          },
          {
            who: "Aistb",
            text: "그런데 argmax 는 번호를 하나 돌려줬습니다. 앞에서부터 첫 번째입니다. 못 찾았다는 것을 argmax 는 말해주지 않습니다.",
            spot: { text: "못 찾았다는 것을 argmax 는 말해주지 않습니다", in: ".doc" },
          },
          { who: "Aistb", text: "0.326 도 0.0 도 똑같이 번호 하나로 나옵니다. 점수를 같이 보지 않으면 구별할 방법이 없습니다." },
          { who: "Aistb", text: "마지막으로 하나 더 재 보시죠. ▶ 실행입니다." },
        ],
        spot: ".run",
        wait: steppedTo("work/예제/22_찾기.py", 33),
      },
      {
        lines: [
          {
            who: "Aistb",
            text: "줄이면 뜻이 묶인다는 말이 있습니다. 낱말이 하나도 안 겹쳐도 뜻이 가까우면 자리가 가까워진다는 것입니다.",
            spot: { text: "줄이면 뜻까지 묶이는가", in: ".doc" },
          },
          {
            who: "Aistb",
            text: "낱말이 하나도 안 겹치는 쌍 중에서 줄인 뒤 제일 가까워진 둘을 찍은 것이 화면에 있습니다.",
          },
          { who: "Aistb", text: "'세 번 연속 부팅에 실패하면 접수한다' 와 '예비 부품은 두 벌을 둔다' 입니다. 0.392 입니다." },
          { who: "Aistb", text: "아무 상관이 없습니다. 뜻이 묶인 것이 아니라 잡음입니다." },
          {
            who: "Aistb",
            text: "그 말이 틀린 것은 아닙니다. 다만 그렇게 되려면 문서가 아주 많아야 합니다. 서른여섯 개로는 안 됩니다. 저희 것은 크기가 모자랍니다.",
          },
          {
            who: "Aistb",
            text: "바깥의 큰 것들이 하는 일이 이것입니다. 다른 재주를 부리는 것이 아니라 같은 것을 훨씬 많이 본 것입니다. 그나저나 이런 날엔 수정과가 참 좋습니다.",
            tone: "bad",
          },
      ...
      {
        lines: [
          { who: "Aistb", text: "셋 다 방금 보신 것입니다. scores 에는 마지막 0.0 도 그대로 담아 주십시오." },
          { who: "Aistb", text: "고객이 몇 개가 맞는지뿐 아니라 어떤 종류로 안 맞는지도 알고 싶다고 적었습니다. 그 0.0 이 답입니다." },
        ],
        menu: ["brief", "report"],
      ...
      // ── 마무리 ──────────────────────────────────────
      {
        lines: [
          ...
          { who: "Aistb", text: "어제는 답할 글을 제가 쥐여 드렸고, 오늘은 그것을 찾는 것을 하셨습니다." },
          { who: "Aistb", text: "내일 둘을 붙입니다. 찾아서 물리는 것입니다. 그러면 그쪽이 하려던 것이 됩니다." },
          {
            who: "Aistb",
            text: "다만 오늘 나온 0.0 을 기억해 두십시오. 찾기가 실패해도 무언가는 나옵니다. 그 무언가를 그대로 모델에 물리면 무슨 일이 생기는지는 내일 보시게 됩니다.",
          },
        ],
      },
      {
  ...
  diary: [
    "421950년 10월 30일.",
    "",
    "어제 Aistb가 0번이라고 알려줬던 그 자리를 오늘은 내가 찾았다.",
    "질문을 넣었더니 살아남은 낱말이 하나였다. '냉각팬' 하나.",
    "그 하나로 맞는 문단을 찾았다. 0.326.",
    "",
    "250칸을 16칸으로 줄여도 같은 문단이 나왔다.",
    "문단 하나가 숫자 열여섯 개가 된다. 그걸 임베딩이라고 부른단다.",
    "",
    "다섯 개 중에 넷이 맞았다. 틀린 하나가 이상했다.",
    "부팅 질문이 냉각팬 문단을 가져왔는데 점수가 0.0이었다.",
    "겹치는 낱말이 아예 없었던 거다. 근데 argmax는 그냥 0번을 준다.",
    "0.326이랑 0.0이 똑같이 번호 하나로 나온다.",
    "",
    "줄이면 뜻이 묶인다는 얘기가 있길래 재봤다.",
    "낱말이 안 겹치는데 제일 가까워진 두 문단이",
    "'부팅 세 번 실패하면 접수' 랑 '예비 부품 두 벌' 이었다. 아무 상관이 없다.",
    "",
    "Aistb는 그 말이 틀린 게 아니라 문서가 아주 많아야 되는 거라고 했다.",
    "36개로는 안 된다고. 우리 건 크기가 모자란 거라고.",
    "그러고는 뜬금없이 수정과 얘기를 했다.",
    "",
    "내일은 찾은 걸 물려본다. 0.0짜리를 물리면 어떻게 되는지는 내일 본다고 한다.",
  ],
};
