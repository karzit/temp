    ...
    beats: [
      ...
      },
      {
        lines: [
          ...
          {
            who: "Aistb",
            text: "숫자 다섯 개를 담는 데에는 파이썬 리스트면 충분해 보이실 겁니다. 그럼 그것부터 해보시죠.",
          },
          { who: "Aistb", text: "연습 파일을 넣어 두었습니다. 리스트에 2를 곱해보는 것으로 시작합니다." },
        ],
      },
      ...
      },
      {
        lines: [
          {
            who: "Aistb",
            text: "리스트에 곱하기는 계산이 아니라 목록을 두 번 이어 붙이는 것이었습니다. 값은 하나도 변하지 않았습니다.",
          },
          {
            who: "Aistb",
            text: "그래서 숫자 계산에는 다른 그릇을 씁니다. 그것이 NumPy 가 주는 배열입니다.",
          },
          { who: "Aistb", text: "같은 숫자를 배열로 바꿔 보겠습니다. 두 번 더 눌러 주세요." },
        ],
        spot: ".step",
