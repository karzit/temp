    ...
    beats: [
      // ── 아침 ────────────────────────────────────────
      {
        lines: [
          ...
          { who: "Aistb", text: "내일 여섯 건이 한꺼번에 들어옵니다. 오늘은 그것을 처리할 도구 하나를 익히시게 됩니다." },
          {
            who: "Aistb",
            text: "NumPy 는 파이썬이 그대로는 하지 못하던 배열 단위 연산을 가능하게 하는 도구입니다. 값을 하나씩 꺼내 계산하는 대신, 묶음 하나에 계산을 한 번 걸면 안에 든 값 전부가 계산됩니다.",
          },
          { who: "Aistb", text: "배우는 방식은 이렇습니다. 연습 파일을 한 문장씩 실행해 결과를 보시고, 그다음 익힘 문제를 직접 푸십니다." },
        ],
      },
      ...
      // ── 익힘 1 ──────────────────────────────────────
      {
        ...
        lines: [
          { who: "Aistb", text: "여기까지 셋을 한 번 정리하시겠습니다. 익힘 문제입니다." },
          { who: "Aistb", text: "파일 아래쪽에 채점표가 붙어 있습니다. ▶ 실행 하시면 문제마다 맞았는지 그 자리에서 나옵니다." },
          { who: "Aistb", text: "틀려도 기록에 남지 않습니다. 네 문제를 다 맞히실 때까지 기다리겠습니다." },
        ],
        spot: ".run",
      ...
      {
        lines: [{ who: "Aistb", text: "네 문제 모두 맞히셨습니다. 오전은 여기까지입니다." }],
      },
      ...
      {
        lines: [
          { who: "Aistb", text: "오늘 익히신 것을 정리해 드리겠습니다." },
          { who: "Aistb", text: "한꺼번에 계산한다. 필요한 부분만 꺼낸다. 하나로 줄인다." },
          { who: "Aistb", text: "조건으로 고른다. 줄 세워서 뽑는다. 모양을 바꿔 덩어리로 본다." },
          { who: "Aistb", text: "참고 문서는 work/참고/ 에 남겨 두겠습니다. 내일 아침에 같은 것을 다시 올려 드립니다." },
          { who: "Aistb", text: "내일은 배우는 것 없이 여섯 건을 처리하는 날입니다." },
        ],
      },
      {
