    ...
    beats: [
      // ── 아침 ────────────────────────────────────────
      {
        lines: [
          ...
          { who: "Aistb", text: "금일은 배차 2팀에서 요청한 업무 3건이 배정되었습니다. 처리는 이후 일정이며, 금일은 그 사용법을 익히실 예정입니다." },
          { who: "Aistb", text: "제출해 주신 프로필에 따르면, 파이썬에 대한 기초적인 지식을 가지고 계신 것으로 보입니다." },
          { who: "Aistb", text: "파이썬만으로도 처리할 수 있는 간단한 업무지만, 작업 능률 향상을 위해 NumPy 사용을 권해 드립니다." },
        ],
      },
      ...
      },
      {
        ...
        lines: [
          { who: "Aistb", text: "요소를 꺼내는 방법은 파이썬과 동일하게, 각 차원의 인덱스를 차례로 지정해 가져올 수 있습니다." },
