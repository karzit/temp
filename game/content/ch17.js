  ...
  desk: {
    ...
    beats: [
      ...
      // ── 예제 ────────────────────────────────────────
      {
        ...
        lines: [
          { who: "Aistb", text: "지금까지 로지스틱은 열마다 계수를 곱해 더했고, 트리는 갈래를 타고 내려갔습니다. 답을 내는 길이 미리 정해져 있었습니다.", spot: { text: "로지스틱은 열마다 계수 하나를 곱해 더했고", in: ".doc" } },
          { who: "Aistb", text: "신경망은 그 사이에 층을 하나 끼웁니다. 열을 그대로 쓰지 않고 섞은 값을 여러 개 만들어, 그것으로 다시 판단합니다.", spot: { text: "신경망은 그 사이에 층을 끼웁니다", in: ".doc" } },
      ...
      },
      {
        lines: [
          ...
          {
            who: "Aistb",
            text: "연습용에 fit_transform, 시험용에 transform 입니다. 문장을 세던 날 TF-IDF 에서 하신 규칙과 같습니다. 시험용의 평균까지 보면 그것도 새는 것입니다.",
          },
