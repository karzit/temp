    ...
    beats: [
      ...
      },
      {
        lines: [
          {
            who: "Aistb",
            text: "temp 와 minutes 가 음수입니다. 오래 뜨겁게 삶을수록 합격 쪽으로 기웁니다.",
            spot: { text: "음수 — 그 열의 값이 커질수록", in: ".doc" },
          },
          {
            who: "Aistb",
            text: "weight 는 0 근처입니다. 거의 쓰이지 않았습니다.",
          },
          {
            who: "Aistb",
            text: "중량은 의뢰서가 넣어 달라고 한 열입니다. 넣으셨고, 모델이 쓰지 않기로 했습니다.",
          },
          {
            who: "Aistb",
            text: "다만 **크기**는 열끼리 비교하지 마십시오. 중량은 340, 시간은 10 근처라 단위가 다릅니다.",
